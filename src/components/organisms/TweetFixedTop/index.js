...
const TweetFixedTop = ({ id, hashtag, title, catchMessage, place, startedAt, name }) => (
  <Tweet
    name={name}
...
TweetFixedTop.displayName = 'TweetFixedTop';

TweetFixedTop.propTypes = {
  id: propTypes.string,
...
TweetFixedTop.defaultProps = {};

export default TweetFixedTop;
